...
//{@assert
    callback && _if(typeof callback !== "function", "invalid PageVisibilityEvent.on(callback)");
//}@assert
...
//{@assert
    callback && _if(typeof callback !== "function", "invalid PageVisibilityEvent.off(callback)");
//}@assert
...
//}@node
global["PageVisibilityEvent"] ? (global["PageVisibilityEvent_"] = PageVisibilityEvent) // already exsists
